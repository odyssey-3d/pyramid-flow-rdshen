...
def get_args():
    ...
    parser.add_argument('--model_path', default='./pyramid_flow_model', type=str, help='Set it to the downloaded checkpoint dir')
    ...
    parser.add_argument('--world_size', default=2, type=int, help="The number of gpus used for inference")
    parser.add_argument('--sp_group_size', default=2, type=int, help="The number of gpus used for inference")
